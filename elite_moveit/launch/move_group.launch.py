...
def generate_launch_description():
    moveit_config = (
        MoveItConfigsBuilder("ec612", package_name="elite_moveit")
        .robot_description(file_path="config/ec612.urdf.xacro")
        .robot_description_semantic(file_path="config/ec612.srdf")
    ...
    # moveit_config = MoveItConfigsBuilder("ec612", package_name="elite_moveit").to_moveit_configs()
